...
public class CalculationContext {
    ...
    public CalculationContext(IBaritone baritone, boolean forUseOnAnotherThread) {
        ...
        this.hasWaterBucket = Baritone.settings().allowWaterBucketFall.value && InventoryUtils.isHotbar(InventoryUtils.getSlotFor(STACK_BUCKET_WATER, player.inventory)) && world.provider.getDimensionId() != -1;
