...
public final class BuilderProcess extends BaritoneProcessHelper implements IBuilderProcess {
    ...
    private Optional<Placement> possibleToPlace(IBlockState toPlace, int x, int y, int z, BlockStateInterface bsi) {
        for (EnumFacing against : EnumFacing.values()) {
            ...
            if (aabb == null) {
                aabb = new AxisAlignedBB(placeAgainstPos.x, placeAgainstPos.y, placeAgainstPos.z,
                        placeAgainstPos.x + 1, placeAgainstPos.y + 1, placeAgainstPos.z + 1);
            }
    ...
    public static final Set<IProperty<?>> orientationProps =
            ImmutableSet.of(BlockRotatedPillar.AXIS, BlockLog.LOG_AXIS, PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL),
